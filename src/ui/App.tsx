    ...
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      <header className="h-12 px-4 flex items-center justify-between border-b border-border bg-card shrink-0">
        <div className="flex items-center gap-3">
          <h1 className="text-sm font-semibold text-foreground">CLONE VectorAnim</h1>
          <span className="text-xs px-2 py-0.5 rounded bg-primary/20 text-primary glow-primary">v0.73</span>
        </div>
        <div className="flex items-center gap-3">
