          ...
          {isLoExpanded && (
            <div className="flex-1 flex flex-col min-h-0 p-2 gap-2">
              ...
              <div className="shrink-0 flex items-center gap-2">
                ...
                <span className="text-[10px] text-foreground font-medium whitespace-nowrap">LO Workflow:</span>
                <Button
                  size="sm"
          ...
          {isVideoExpanded && (
            <div className="flex-1 flex flex-col min-h-0 p-2 gap-2">
              ...
              <div className="shrink-0 flex items-center gap-2">
                ...
                <span className="text-[10px] text-foreground font-medium whitespace-nowrap">Video Workflow:</span>
                <Button
                  size="sm"
                  className="h-6 text-[10px] whitespace-nowrap bg-orange-500 hover:bg-orange-600 text-white px-2"
